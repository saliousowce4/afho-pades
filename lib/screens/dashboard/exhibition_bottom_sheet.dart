...
final List<Event> events = [
  Event('kissi.jpg', 'Kissi', '4.20-30'),
  Event('kpele.jpg', 'Kpélé', '4.20-30'),
  Event('soussou.jpg', 'Soussou', '4.28-31'),
];
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(
              text: "LISTE DES ELECTEURS",
              color: kPrimaryColor,
              textColor: Colors.white,
              press: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ElecteurListView()),
                );
              },
            ),
